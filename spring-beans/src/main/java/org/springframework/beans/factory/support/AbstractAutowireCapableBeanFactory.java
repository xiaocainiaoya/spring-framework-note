...
public abstract class AbstractAutowireCapableBeanFactory extends AbstractBeanFactory
	 ...
	 * @param beanName the name of the bean (for error handling purposes) bean名称
	 * @param mbd the merged bean definition for the bean rootBeanDefinition定义对象
	 * @param bean the raw bean instance 实例化之后的对象
		...
		if (!Boolean.FALSE.equals(mbd.beforeInstantiationResolved)) {
			...
			if (!mbd.isSynthetic() && hasInstantiationAwareBeanPostProcessors()) {
				...
				if (targetType != null) {
					...
					// 若bean不为空, 则说明存在代理对象, 则调用后置
					if (bean != null) {
						// 调用所有BeanPostProcessor#postProcessAfterInitialization后置接口
	...
	protected Object initializeBean(final String beanName, final Object bean, @Nullable RootBeanDefinition mbd) {
		...
		if (mbd == null || !mbd.isSynthetic()) {
			...
			// (ApplicationContextAwareProcessor#postProcessBeforeInitialization -> 对实现了ApplicationContextAware的bean调用唯一接口)
